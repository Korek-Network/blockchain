...
assert.ok(["korek-local-multinode-benchmark/1", "korek-local-multinode-benchmark/2", "korek-local-multinode-benchmark/3", "korek-local-multinode-benchmark/4"].includes(report.version));
